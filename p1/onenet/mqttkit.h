...
enum MqttPacketType
{
    ...
    MQTT_PKT_PUBLISH,     /**< ??????? */
    MQTT_PKT_PUBACK,      /**< ??????? */
    MQTT_PKT_PUBREC,      /**< ??????????,Qos 2?,??MQTT_PKT_PUBLISH */
    MQTT_PKT_PUBREL,      /**< ?????????, Qos 2?,??MQTT_PKT_PUBREC */
    MQTT_PKT_PUBCOMP,     /**< ???????, Qos 2?,??MQTT_PKT_PUBREL */
    MQTT_PKT_SUBSCRIBE,   /**< ????? */
    MQTT_PKT_SUBACK,      /**< ??????? */
    MQTT_PKT_UNSUBSCRIBE, /**< ??????? */
    MQTT_PKT_UNSUBACK,    /**< ????????? */
    MQTT_PKT_PINGREQ,     /**< ping ??? */
    MQTT_PKT_PINGRESP,    /**< ping ????? */
    MQTT_PKT_DISCONNECT,  /**< ??????? */
